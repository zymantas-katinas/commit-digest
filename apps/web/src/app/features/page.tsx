        ...
        <section className="container space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-24">
          <div className="mx-auto flex max-w-[980px] flex-col items-center gap-2 text-center">
            ...
            <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
              Transform your development process with intelligent commit
              analysis, automated git reporting, and seamless team
              collaboration. Every feature designed to save developer time and
              provide clear insights into your code's progress.
            </p>
            <div className="max-w-[650px] py-4">
              <p className="text-base text-muted-foreground">
                ...
                human-readable summaries that help development teams,
                engineering managers, and stakeholders understand progress
                effortlessly.
              </p>
            </div>
          </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="relative overflow-hidden border-2 border-primary/20 hover:border-primary/40 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    into clear, human-readable insights that everyone on your
                    team can understand, regardless of technical background.
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="relative overflow-hidden border-2 border-green-500/20 hover:border-green-500/40 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>
                    Schedule daily, weekly, or custom frequency reports that
                    keep your development team synchronized without manual
                    intervention or time-consuming status meetings.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2 text-sm">
              ...
              <Card className="relative overflow-hidden border-2 border-blue-500/20 hover:border-blue-500/40 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>
                    Connect private and public repositories safely using
                    Personal Access Tokens with enterprise-grade security. Your
                    code stays private and protected.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2 text-sm">
              ...
              <Card className="relative overflow-hidden border-2 border-purple-500/20 hover:border-purple-500/40 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>
                    Send intelligent commit summaries to Slack, Discord, email,
                    or any custom webhook endpoint with full JSON payload
                    support. Integrate seamlessly with your existing
                    communication tools.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
              ...
              <Card className="relative overflow-hidden border-2 border-teal-500/20 hover:border-teal-500/40 transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    perfectly aligned with clear, accessible progress updates
                    that everyone can understand, regardless of technical
                    background.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Generate beautifully formatted Markdown reports with
                      proper headers, organized lists, and highlighted code
                      blocks that are easy to read, share, and integrate into
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      preferences, and formatting options to perfectly match
                      your team's unique workflow requirements and communication
                      preferences.
                    </p>
                  </div>
                </div>
              ...
              <Card className="text-center">
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    communication with automated git progress summaries that
              ...
              <Card className="text-center">
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    momentum, and development progress without micromanaging
                    your developers
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="text-center">
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    without needing to dive into complex code changes or
                    technical details
                  </CardDescription>
                </CardHeader>
                <CardContent>
