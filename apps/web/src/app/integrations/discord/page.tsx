      ...
      <section className="container space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-24">
        <div className="mx-auto flex max-w-[980px] flex-col items-center gap-2 text-center">
          ...
          <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
            Automated AI-powered commit summaries sent directly to your Discord
            server. Perfect for gaming communities, development teams, and
        ...
        <div className="mx-auto max-w-[980px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Ideal for gaming communities building mods, indie developers,
                  and open-source projects with Discord-focused development
                  workflows.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Discord's native markdown support means your commit summaries
                  look great with full formatting, links, and code blocks
                  preserved.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Transform technical commit messages into readable development
                  updates that both developers and community members can
                  understand.
                </p>
              </CardContent>
            </Card>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="text-sm space-y-1 ml-4">
                        ...
                        <div>• Implemented real-time notifications system</div>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>• Support for longer, detailed development summaries</li>
        ...
        <div className="mx-auto max-w-[980px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Showcase development progress to contributors and maintainers
                  with automated commit summary notifications.
                </p>
              </CardContent>
            </Card>
          ...
          <Card className="p-8">
            <CardContent className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground">
                ...
                your Discord server today. Free forever for public repositories.
              </p>
