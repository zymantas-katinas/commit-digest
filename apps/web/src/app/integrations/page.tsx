      ...
      <section className="container space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-24">
        <div className="mx-auto flex max-w-[980px] flex-col items-center gap-2 text-center">
          ...
          <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
            Receive AI-powered commit summaries directly where your team works.
            Automated development progress notifications delivered to your
            favorite platforms and tools.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[980px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <Card className="relative overflow-hidden group hover:shadow-lg transition-shadow">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Bring AI-powered development summaries to your Discord server.
                  Full markdown support, no character limits, and perfect for
                  gaming communities and open-source projects.
                </p>
          ...
          <Card className="p-8">
            <CardContent className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground">
                ...
                wherever your team works. Free forever for public repositories.
              </p>
