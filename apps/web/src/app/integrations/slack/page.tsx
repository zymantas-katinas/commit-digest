        ...
        <section className="container space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-24">
          <div className="mx-auto flex max-w-[980px] flex-col items-center gap-2 text-center">
            ...
            <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
              ...
              channels. Keep your team updated with beautiful development
              progress notifications on your schedule.
            </p>
          ...
          <div className="mx-auto max-w-[980px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Just paste your Slack webhook URL and you're ready to
                    receive commit summaries. No complex configurations needed.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Get intelligent development progress summaries that
                    highlight key features, bug fixes, and improvements rather
                    than raw commit messages.
                  </p>
                </CardContent>
              </Card>
            ...
            <Card className="p-8">
              <CardContent className="space-y-6">
                ...
                <p className="text-xl text-muted-foreground">
                  ...
                  your Slack channels today. Free forever for public
                  repositories.
                </p>
